...
<template>
  <div class=" .d-sm-none .d-md-block col-md-2 bg-dark">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input v-model="newList.name" type="text" class="form-control" id="exampleFormControlInput1" required />
          </div>
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input v-model="newList.group" type="text" class="form-control" placeholder="neue Gruppe hinzufügen"
                aria-label="Recipient's username" aria-describedby="button-addon2" />
            </div>
          </div>
          <div class="mb-3">
            <label for="exampleColorInput" class="form-label">Farbe</label>
            <input type="color" class="form-control form-control-color" id="exampleColorInput" v-model="newList.color"
